...
var components = (0, _entries.default)({
...
function Select(props) {
  ...
  return /*#__PURE__*/_react.default.createElement("select", {
    ...
    onChange: function onChange(e) {
      var selectedValues = (0, _from.default)(e.target.selectedOptions, function (option) {
        return option.value;
      });
...
exports.NOTICE_TYPE_ERROR = exports.NOTICE_TYPE_SUCCESS = void 0;
...
function NoticesProvider(props) {
  ...
  var notify = useCallback(function (_ref) {
    ...
    var key = (0, _now.default)() + Math.random();
    setNotices(function (prev) {
      return [{
        key: key,
        message: message,
...
_Object$defineProperty(exports, "Restore", {
  enumerable: true,
  get: function get() {
...
_Object$defineProperty(exports, "Export", {
  enumerable: true,
  get: function get() {
...
_Object$defineProperty(exports, "Referer", {
  enumerable: true,
  get: function get() {
...
exports.STATUS_ERROR = exports.STATUS_SUCCESS = exports.STATUS_LOADING = exports.STATUS_IDLE = void 0;
...
exports.EXPORT_MODE_FILTERED = exports.EXPORT_MODE_SELECTED = exports.EXPORT_MODE_ALL = void 0;
...
function useExport(hookOptions) {
  ...
  var mode = useMemo(function () {
    ...
    var filter = Object.fromEntries((0, _entries.default)(options.filter).filter(function (_ref) {
      var _ref2 = (0, _slicedToArray2.default)(_ref, 2),
          value = _ref2[1];
    ...
    if (1 === (0, _keys.default)(filter).length && 'all' === filter.status) {
  ...
  var _useDataAction = (0, _useDataAction3.default)(function (_ref3, _ref4) {
    ...
    return promise.then(function () {
      return downloadExportsResults((0, _values.default)(exportDataByForm));
    }).catch(function (error) {
...
function useQuery() {
  ...
  var flatQuery = useMemo(function () {
    return Object.fromEntries((0, _entries.default)((0, _objectSpread5.default)((0, _objectSpread5.default)({}, query.filter), {}, {
      ...
      if ((0, _isArray.default)(value) && 0 === value.length) {
        return false;
      }
...
function normalizeFetchOptionsResult(data, allowedFilters) {
  ...
  return (0, _entries.default)(endpoint.args).reduce(function (current, _ref5) {
...
function Index() {
  ...
  })), (0, _entries.default)(tableTitles).map(function (_ref10) {
...
/******/ 			if (chunkId === "jszip.vendor") return "" + chunkId + ".8911033537a0c9d6e5f8.bundle.js";
