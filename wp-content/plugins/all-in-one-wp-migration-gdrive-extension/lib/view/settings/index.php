				...
				<div class="ai1wm-field">
					...
					<?php else : ?>
						...
						<form method="post" action="<?php echo esc_url( AI1WMGE_REDIRECT_CREATE_URL ); ?>">
							...
							<input type="hidden" name="ai1wmge_site_url" id="ai1wmge-site-url" value="example.com" />
							<input type="hidden" name="ai1wmge_admin_email" id="ai1wmge-admin-email" value="admin@example.com" />
