      ...
      '<div class="uip-padding-s uip-position-relative" :accountConnected="isGAconnected">\
        ...
        <div v-if="!editingMode && loading != true && isGAconnected">\
          <div class="uip-flex uip-flex-center uip-margin-bottom-xs">\
            <span  class="material-icons-outlined uip-margin-right-xs uip-text-xl" >speed</span>\
            <div class="uip-margin-right-s uip-text-xxl uip-text-emphasis uip-text-bold" style="margin:0;margin-right:10px">{{numbers.total}}s</div>\
            <span class="uip-background-primary-wash uip-border-round uip-padding-xxs uip-text-bold uip-flex" \
