          ...
          <div class="uip-w-100p uip-min-w-300 uip-overflow-auto">\
            ...
            <div>\
                <div v-for="item in tableData" class="uip-flex uip-flex-center uip-margin-bottom-s">\
                    ...
                    <div class="uip-margin-left-s uip-w-80 uip-text-right uip-text-bold uip-flex-no-shrink uip-overflow-hidden uip-text-ellipsis uip-no-wrap">{{item.visits}}</div>\
