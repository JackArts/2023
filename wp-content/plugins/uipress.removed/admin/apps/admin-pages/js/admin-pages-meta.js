...
const uipAdminPagesMetaBoxOptions = {
  data() {
    return {
      thisSearchInput: "",
  ...
  mounted: function () {
    this.menuitemicon = jQuery("#uip-ap-menu-icon").val();
  },
  methods: {
    chosenicon(thicon) {
      this.menuitemicon = thicon;
      jQuery("#uip-ap-menu-icon").val(thicon);
    },
    removeIcon() {
      thicon = "removeicon";
      this.menuitemicon = "";
      jQuery("#uip-ap-menu-icon").val();
    },
  ...
  template:
    '<div style="z-index:999">\
		  ...
		  <div v-if="ui.options" \
		  class="uip-position-fixed uip-padding-s uip-background-default uip-border-round uip-shadow uip-drop-bottom uip-w-300 uip-z-index-9">\
			<!-- SEARCH COMP -->\
...
const uipAPmeta = uipVue.createApp(uipAdminPagesMetaBoxOptions);

if (jQuery("#uip-admin-page-icon-select").length > 0) {
  uipAPmeta.mount("#uip-admin-page-icon-select");
}
