...
class PhpValidation extends \DynamicContentForElementor\Extensions\ExtensionPrototype
{
    ...
    const CONTROL_ENABLED = 'dce_custom_php_validation_enabled';
    public function run_once()
    {
        $save_guard = \DynamicContentForElementor\Plugin::instance()->save_guard;
        $save_guard->register_unsafe_control('form', self::CONTROL_ENABLED, 'yes');
    }
