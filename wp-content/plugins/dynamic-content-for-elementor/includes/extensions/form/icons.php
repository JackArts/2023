...
class Icons extends \DynamicContentForElementor\Extensions\ExtensionPrototype
{
    ...
    public function update_fields_controls($widget)
    {
        ...
        $icons_activated = ['tel', 'text', 'email', 'textarea', 'number', 'url', 'password', 'dce_js_field', 'amount', 'select'];
    ...
    public function add_background_section($widget)
    {
        ...
        $widget->add_control('label_icon_size', ['label' => __('Size on Label', 'dynamic-content-for-elementor'), 'type' => Controls_Manager::SLIDER, 'default' => ['unit' => 'px', 'size' => ''], 'range' => ['px' => ['min' => 10, 'max' => 50, 'step' => 1]], 'frontend_available' => \true, 'selectors' => ['{{WRAPPER}} .label-icons' => 'font-size: {{SIZE}}{{UNIT}}; height: {{SIZE}}{{UNIT}}']]);
        $widget->add_control('field_icon_size', ['label' => __('Size on Input', 'dynamic-content-for-elementor'), 'type' => Controls_Manager::SLIDER, 'default' => ['unit' => 'px', 'size' => ''], 'range' => ['px' => ['min' => 10, 'max' => 50, 'step' => 1]], 'frontend_available' => \true, 'selectors' => ['{{WRAPPER}} .dce-field-input-wrapper i.input-icons' => 'font-size: {{SIZE}}{{UNIT}};', '{{WRAPPER}} .dce-field-input-wrapper svg.input-icons' => 'height: {{SIZE}}{{UNIT}}; width: {{SIZE}}{{UNIT}};']]);
