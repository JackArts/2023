...
class AddToCalendar extends \DynamicContentForElementor\Widgets\WidgetPrototype
{
    ...
    protected function render()
    {
        ...
        $title = !empty($settings['dce_calendar_title']) ? sanitize_text_field($settings['dce_calendar_title']) : __('Event', 'dynamic-content-for-elementor');
        $description = !empty($settings['dce_calendar_description']) ? wp_kses_post($settings['dce_calendar_description']) : '';
        $address = !empty($settings['dce_calendar_location']) ? sanitize_text_field($settings['dce_calendar_location']) : '';
