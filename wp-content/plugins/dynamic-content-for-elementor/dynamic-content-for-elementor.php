...
function dce_admin_notice_minimum_php_version() {
	\DynamicContentForElementor\Notice::error( sprintf( __( 'You are using PHP version %1$s. This version is not more supported. Ask your provider to use PHP version %2$s+.', 'dynamic-content-for-elementor' ), phpversion(), DCE_SUGGESTED_PHP_VERSION ) );
}
