...
function dce_hide_modal(id_modal){var id_modal_scope=id_modal.split('-');id_modal_scope.pop();id_modal_scope=id_modal_scope.join('-');if(!elementSettings.always_visible){dce_setCookie(id_modal,1,elementSettings.cookie_lifetime)}
