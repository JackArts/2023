    ...
    var WidgetElements_DynamicCharts = function ($scope, $) {
		...
		if( useRandomColors ) {
			for (var i in data) {
				...
				randomBackgroundColors.push( `rgba(${color[0]}, ${color[1]}, ${color[2]}, ${backgroundOpacity})` );
				randomBorderColors.push( `rgba(${color[0]}, ${color[1]}, ${color[2]}, ${borderOpacity})` );
			}
		}
		...
		new Chart(ctx, {
			...
			data: {
				...
				datasets: [{
					...
					data: data,
					backgroundColor: useRandomColors ? randomBackgroundColors : elementSettings.background_data,
					borderColor: useRandomColors ? randomBorderColors : [ elementSettings.border_data ],
