...
context.scale(ratio,ratio);clearButton.addEventListener("click",function(event){context.fillStyle=canvas.getAttribute('data-background-color');context.fillRect(0,0,responsiveWidth,responsiveWidth/2);signaturePad.clear()})}
