...
<div class="mkdf-video-button-holder <?php echo esc_attr($holder_classes); ?>">
	...
	<?php } else { ?>
		<a class="mkdf-video-button-text-holder" <?php echo wilmer_mikado_get_inline_style($play_button_styles); ?> href="<?php echo esc_url($video_link); ?>" data-rel="prettyPhoto[video_button_pretty_photo_<?php echo esc_attr($rand); ?>]">
			<span class="mkdf-video-button-text"><?php echo esc_html__('Watch the Video', 'wilmer-core'); ?></span>
		</a>
		<a class="mkdf-video-button-play" <?php echo wilmer_mikado_get_inline_style($play_button_styles); ?> href="<?php echo esc_url($video_link); ?>" data-rel="prettyPhoto[video_button_pretty_photo_<?php echo esc_attr($rand); ?>]">
			<span class="mkdf-video-button-play-inner">
